...
let create_effect name description effect = { name; description; effect }
  ...
  [
    ...
    (* {
         ...
         effect = (Some {
           ...
           effect = [Buff (Some ["General Knowledge";
           "Writing"; "Coding"], 15), 5; Debuff (Some ["Math"], 5), 5];
         }, None)
       }; *)
    {
      name = "Throw Item";
    ...
    (* {
       ...
       {
         name = "Belittle";
         required = [("Confidence", 100); ("Knowledge", 100);
         ("Aggressiveness", 100)];
         effect = (None, Some{
           name = "Belittlement";
           description = "has been belittled";
           effect = [Debuff (Some ["Confidence"], 10), 5;
           Debuff (None, 5), 5]
         })
       } *)
  ]
